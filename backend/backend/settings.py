...
SECRET_KEY = 'django-insecure-h_gp*v6n-&a#+_kkw9h4h=0s3cn%4tg()^m12v4!@ohsw=x1uy'
...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",  # NEW: must be at top
...
CORS_ALLOW_ALL_ORIGINS = True   # Allow all (dev only!)
